...
<body>
    <div class="flex-container">
        <?php 
            ...
            $query = "SELECT cat_name,image FROM gallery_category WHERE event_id = 1;";
            ...
            while($data = mysqli_fetch_assoc($result)){
                ...
                $c_id = "SELECT cat_id,event_id FROM gallery_category WHERE cat_name = '$catname';";
                ...
                echo "<a href='details.php?var=" . $catid . "'> <h4>{$data['cat_name']}</h4> </a>";
                echo "</div>";
                echo "</div>";
                //echo $catid;echo "<br>";
            }
